  ...
  <!-- <span class="text-white">Album :</span> -->
      ...
      <div class="row">
          ...
          if (isset($_GET['albumid'])){
              ...
              <!-- Modal -->
        <!-- <div class="modal fade" id="album<?php echo $row['albumid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><?php echo $row['namaalbum'] ?></h5>
